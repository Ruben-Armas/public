        ...
        while ( have_posts() ) :
          ...
          <h1 class="entry-title"><?php the_title(); ?></h1>
            ...
            <div class="col-6">
              ...
              ?>
              <div class="entry-social row">
                <div class="col-6">            
                  <span>Compartir en las redes:</span>
                </div>
                <div class="col-6">
                  <a class="ulpgcds-btn ulpgcds-btn--ghost ulpgcds-btn--icon" style="display: inline-block;" target="_blank" href="<?php echo esc_url($facebook_share_url); ?>"><i class="ulpgcds-btn__icon ulpgcds-icon-facebook"></i></a>
                  <a class="ulpgcds-btn ulpgcds-btn--ghost ulpgcds-btn--icon" style="display: inline-block;" target="_blank" href="<?php echo esc_url($twitter_share_url); ?>"><i class="ulpgcds-btn__icon ulpgcds-icon-twitter"></i></a>
                  <a class="ulpgcds-btn ulpgcds-btn--ghost ulpgcds-btn--icon" style="display: inline-block;" target="_blank" href="<?php echo esc_url($linkedin_share_url); ?>"><i class="ulpgcds-btn__icon ulpgcds-icon-linkedin"></i></a>
                </div>
              </div>
            </div>
          </div>
