<?php /* /home/vboxuser/Local Sites/prueba/app/public/wp-content/plugins/akeebabackupwp/app/Solo/ViewTemplates/Log/default.blade.php */ ?>
<?php
/**
 * @package   solo
...
<?php if(isset($this->logs) && count($this->logs)): ?>
    <form name="adminForm" id="adminForm" action="<?php echo $this->container->router->route('index.php?view=Log'); ?>" method="POST"
        ...
        <div class="akeeba-form-group">
            ...
            <?php echo \Awf\Html\Html::_('select.genericList', $this->logs, 'tag', ['list.attr' => ['class' => 'akeebaGridViewAutoSubmitOnChange'], 'list.select' => $this->tag, 'id' => 'tag']); ?>
        </div>
